...
export class CameraController {
  ...
  private updateAim() {
    ...
    if (this.input.keys.has('d') || this.input.keys.has('arrowleft')) this.orbitAngle -= 0.03;
    if (this.input.keys.has('a') || this.input.keys.has('arrowright')) this.orbitAngle += 0.03;
